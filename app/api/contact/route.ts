...
export async function POST(req: NextRequest) {
  ...
  if (!apiKey) {
    console.log("Contact form submission (no RESEND_API_KEY):", { name, company, email });
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
              ...
              <tr><td style="padding: 10px 8px; font-weight: bold; color: #555;">Email:</td><td style="padding: 10px 8px;"><a href="mailto:${email}" style="color: #2563eb;">${email}</a></td></tr>
